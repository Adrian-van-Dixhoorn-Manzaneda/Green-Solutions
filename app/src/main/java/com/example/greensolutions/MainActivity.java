...
public class MainActivity extends AppCompatActivity {
    ...
    // Configura el menú en la Toolbar
    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // Submenú - Opción "Subopción 1"
        if (item.getItemId() == R.id.item_sub_option1) {
            loadFragment(new SecondFragment());
            return true;
        }

        // Submenú - Opción "Subopción 2"
        if (item.getItemId() == R.id.item_sub_option2) {
    ...
    private void closeSession() {
        // Clear any saved login state (optional)
